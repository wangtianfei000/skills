...
"""
Standalone Edge TTS utility copied into this skill as a bundled resource.

Use this file from the skill's scripts/ directory instead of importing code
from any host project package.
"""
